...
class _$EnvironmentImpl implements _Environment {
  ...
  @override
  String toString() {
    return 'Environment(id: $id, name: $name, variables: $variables, isActive: $isActive, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _Environment implements Environment {
  const factory _Environment(
      ...
      required final DateTime updatedAt}) = _$EnvironmentImpl;
